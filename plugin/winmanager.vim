...
" Added by broton
" Do not use my listing file function when trig start window manager
if !exists("g:isStartWinManager")
...
" go to edit area command
" History: broton
if !exists(':GotoEdittingWindow')
	command -nargs=0 GotoEditingWindow :silent call <SID>GotoEditingArea()
end
